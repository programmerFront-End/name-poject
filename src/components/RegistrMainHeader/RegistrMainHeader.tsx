...
const RegistrMainHeader: React.FC = () => {
          ...
          <div className="registerMainHeader">
            <div className="registerMainNav">
              <div className="registerMainNavText">
                <h1>ЗАРЕГИСТРИРУЙТЕСЬ ЧТОБЫ ПОЛУЧИТЬ 20% </h1>
              ...
              {emailAndPhone === "email" ? (
                ...
                <>
                  <input type="tel" placeholder="+996 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ " />
                </>
              )}
             {
             emailAndPhone === "email"? (
             ...
             {
              emailAndPhone === "email"? (
                <button className="singin">ЗАРЕГИСТРИРОВАТЬСЯ</button>
              ):(
                <>
...
export default RegistrMainHeader;
